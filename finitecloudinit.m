function [rArray,cArray,pArray,fArray,hArray,aArray,vArray,mArray]=finitecloudinit(B,N,T)
    % 定义行数和列数
    rows = 30;
    cols = 6;
    ...
    mArray = zeros(rows, 1);
    % 输入数据R
    rArray =  [843776,2662400,1564672,1359872,2785280,958464,1253376,2310144,2359296,1007616,2228224,2334720,1359872,2056192,2654208,1613824,2064384,1605632,2785280,2891776,3276800,3153920,950272,2031616,3088384,3014656,933888,2383872,3956736,2908160]';
    % kth设备上计算1bit所需的cpu周期
    
    cArray = [1476,742,1097,982,1460,1019,1301,556,1152,1170,1460,937,1449,938,648,1486,1436,520,1094,577,909,1308,823,1124,1250,1129,1087,1064,1438,648]';
    % 一个cpu cycle所消耗的能量
    pArray = [0.0497e-12,0.1166e-11,0.1491e-29,0.1753e-16,0.1406e-16,0.0731e-15,0.0212e-18,0.0517e-13,0.1457e-25,0.0072e-19,0.1168e-14,0.1673e-18,0.1896e-11,0.1009e-17,0.0728e-14,0.1687e-19,0.1782e-14,0.0063e-19,0.0341e-17,0.1125e-12,0.0182e-17,0.1043e-19,0.0155e-15,0.0277e-19,0.0614e-26,0.1253e-16,0.0325e-17,0.0289e-11,0.0283e-27,0.0957e-29]';
    % kth设备的cpu能力
